...
@interface FourthViewController : BaseViewController<UIAlertViewDelegate,UITextFieldDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,CollectionHeaderViewDelegate,CHPickerViewDelegate,UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>
{
    NSString *topId;
